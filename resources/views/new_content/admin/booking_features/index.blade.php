...
<div class="collapse mb-4 {{ request()->anyFilled(['search', 'is_active']) ? 'show' : '' }}" id="filterCollapse">
  <div class="card card-body">
    <form id="filterForm" method="GET" action="{{ route('booking-features.index') }}">
      <div class="row g-3">
        <div class="col-md-5">
        ...
        <div class="col-md-4">
          ...
          @endphp
          <x-filter-dropdown name="is_active" :options="$statusOptions" :selected="request('is_active')" placeholder="All Status" />
        </div>
        <div class="col-md-3 d-flex align-items-end">
          <div class="d-flex gap-2 w-100">
            <a href="{{ route('booking-features.index') }}" class="btn btn-secondary w-50">Reset</a>
