...
<div class="d-flex justify-content-between align-items-center mb-4">
  <div>
    <h3 class="mb-1 fw-bold">Restaurant Categories</h3>
    <p class="text-muted mb-0">Manage restaurant categories and cuisines.</p>
  </div>
...
<div class="collapse mb-4 {{ request()->anyFilled(['search', 'status']) ? 'show' : '' }}" id="filterCollapse">
  <div class="card card-body">
    <form id="filterForm" method="GET" action="{{ route('restaurant-categories.index') }}">
      <div class="row g-3">
        <div class="col-md-5">
        ...
        <div class="col-md-3 d-flex align-items-end">
          <div class="d-flex gap-2 w-100">
            <a href="{{ route('restaurant-categories.index') }}" class="btn btn-secondary w-50">Reset</a>
...
<div class="card">
  <div id="ajax-table-container">
    @include('new_content.admin.restaurant_categories._table')
  </div>
</div>
@endsection
