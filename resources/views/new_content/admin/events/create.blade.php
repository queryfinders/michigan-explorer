      ...
      <div class="tab-content p-0" id="eventFormTabsContent">
        ...
        <div class="tab-pane fade show active" id="basic-pane" role="tabpanel" aria-labelledby="basic-tab">
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="hidden" name="event_category_id" id="event_category_id" value="{{ old('event_category_id') }}" required />
                  ...
                  <div class="cuisine-items-list" id="categoryItemsList">
                    ...
                    <label class="cuisine-item" id="cat-label-{{ $cat->id }}">
                      <input type="radio" name="_cat_radio" value="{{ $cat->id }}"
                             ...
                             data-name="{{ $cat->name }}"
                             data-id="{{ $cat->id }}"
                             {{ old('event_category_id') == $cat->id ? 'checked' : '' }}
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. Grand Rapids Art Festival" />
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label fw-semibold" for="slug">Slug <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug') }}" required placeholder="e.g. grand-rapids-art-festival" />
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" id="venue_name" name="venue_name" value="{{ old('venue_name') }}" placeholder="e.g. Calder Plaza" />
            </div>
            <div class="col-md-4 mb-3">
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <textarea class="form-control" id="map_iframe" name="map_iframe" rows="3" placeholder="Paste Google Maps iframe code here">{{ old('map_iframe') }}</textarea>
            </div>
          </div>
        ...
        <div class="tab-pane fade" id="featured-pane" role="tabpanel" aria-labelledby="featured-tab">
          <div class="mb-3">
            ...
            <div class="form-text">Max 4MB. JPG, PNG, WebP supported. This is the main image shown in listings.</div>
          </div>
          ...
          <div class="mb-3 border-top pt-3">
            ...
            <input type="url" class="form-control" id="video_url" name="video_url" value="{{ old('video_url') }}" placeholder="e.g. https://www.youtube.com/watch?v=dQw4w9WgXcQ" />
        ...
        <div class="tab-pane fade" id="seo-pane" role="tabpanel" aria-labelledby="seo-tab">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="e.g. Best Festival in GR | Michigan Explorer" />
          </div>
          <div class="mb-3">
            <label class="form-label fw-semibold" for="meta_description">Meta Description</label>
            <textarea class="form-control" id="meta_description" name="meta_description" rows="2" placeholder="e.g. Discover the best festival..."></textarea>
          </div>
          <div class="mb-3">
