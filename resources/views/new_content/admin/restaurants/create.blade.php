      ...
      <div class="tab-content p-0" id="restaurantFormTabsContent">
        ...
        <div class="tab-pane fade" id="details-pane" role="tabpanel" aria-labelledby="details-tab">
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" id="cuisine" name="cuisine" placeholder="e.g. Fine Dining, Seafood, Italian" value="{{ old('cuisine') }}" />
            </div>
            <div class="col-md-4 mb-3">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="url" class="form-control" id="affiliate_url" name="affiliate_url" placeholder="e.g. OpenTable or Resy link" value="{{ old('affiliate_url') }}" />
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="tab-pane fade" id="featured-pane" role="tabpanel" aria-labelledby="featured-tab">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="featured_image_alt" name="featured_image_alt" placeholder="e.g. Lakeside dining room at Sunrise Café in Traverse City" />
        ...
        <div class="tab-pane fade" id="gallery-pane" role="tabpanel" aria-labelledby="gallery-tab">
          <div class="mb-3">
            ...
            <div class="form-text">Select multiple images at once. Max 4MB each. JPG/PNG/WebP supported. These will appear in the restaurant detail page gallery.</div>
          </div>
    ...
    if (input.files) {
      Array.from(input.files).forEach((file, index) => {
        ...
        reader.onload = function(e) {
          ...
          col.innerHTML = `
            <div class="card h-100 shadow-sm border">
              ...
              <div class="card-body p-2">
                <span class="badge bg-secondary">Image #${index + 1}</span>
              </div>
            </div>
          `;
          ...
          altDiv.innerHTML = `
            <label class="form-label text-muted small">Alt Text for Image #${index + 1}</label>
            <input type="text" class="form-control form-control-sm" name="gallery_alts[${index}]" placeholder="e.g. Dining area table setting" />
          `;
