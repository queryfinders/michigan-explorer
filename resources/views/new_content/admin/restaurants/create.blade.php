        ...
        <div class="tab-pane fade" id="details-pane" role="tabpanel" aria-labelledby="details-tab">
              ...
              <div class="cuisine-dropdown-wrapper" id="cuisineDropdownWrapper">
                ...
                <div class="cuisine-dropdown-panel" id="cuisineDropdownPanel" style="display:none;">
                  ...
                  <div class="cuisine-items-list" id="cuisineItemsList">
                    ...
                    <label class="cuisine-item" id="cuisine-label-{{ $cuisine->id }}">
              ...
              <div class="feature-dropdown-wrapper" id="featureDropdownWrapper">
                ...
                <div class="feature-dropdown-panel" id="featureDropdownPanel" style="display:none;">
                  ...
                  <div class="feature-items-list" id="featureItemsList">
                    ...
                    <label class="feature-item" id="feature-label-{{ $feature->id }}">
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="number" class="form-control" id="starting_price" name="starting_price" value="{{ old('starting_price') }}" placeholder="e.g. 199" />
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" id="zip" name="zip" value="{{ old('zip') }}" placeholder="e.g. 49757" />
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label" for="address">Street Address</label>
              <input type="text" class="form-control" id="address" name="address" value="{{ old('address') }}" placeholder="e.g. 286 Grand Avenue" />
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 mb-3">
              <label class="form-label" for="phone">Phone Number</label>
              <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" placeholder="e.g. +1 555-123-4567" />
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label" for="email">Email</label>
              <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="e.g. info@example.com" />
            </div>
            {{--
            <div class="col-md-4 mb-3">
              <label class="form-label" for="website">Website URL</label>
              <input type="url" class="form-control" id="website" name="website" value="{{ old('website') }}" placeholder="e.g. https://www.example.com" />
            </div>
            --}}
          </div>
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="url" class="form-control" id="affiliate_url" name="affiliate_url" value="{{ old('affiliate_url') }}" placeholder="e.g. https://booking.com/..." />
            </div>
            <div class="col-md-6 mb-3">
