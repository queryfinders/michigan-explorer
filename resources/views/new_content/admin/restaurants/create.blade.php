    ...
    if (files.length > 0) {
      ...
      files.forEach((file, index) => {
        ...
        reader.onload = e => {
          ...
          altDiv.innerHTML = `<label class="form-label text-muted small">Alt Text for Image #${index + 1}</label><input type="text" class="form-control form-control-sm" name="gallery_alts[${index}]" placeholder="e.g. Dining area table setting" />`;
