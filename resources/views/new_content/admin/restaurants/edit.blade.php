      ...
      <div class="tab-content p-0" id="restaurantFormTabsContent">
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="hidden" name="restaurant_category_id" id="restaurant_category_id"
                     value="{{ old('restaurant_category_id', $restaurant->restaurant_category_id) }}" />
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $restaurant->name) }}" placeholder="e.g. The Grand Hotel" />
              @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label" for="slug">Slug <span class="text-danger">*</span></label>
              <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $restaurant->slug) }}" placeholder="e.g. the-grand-hotel" />
        ...
        <div class="tab-pane fade" id="details-pane" role="tabpanel" aria-labelledby="details-tab">
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="hidden" name="city" id="city" value="{{ old('city', $restaurant->city) }}" />
                  ...
                  <div class="cuisine-items-list" id="cityItemsList">
                    ...
                    <label class="cuisine-item" id="city-label-{{ $loop->index }}">
                      <input type="radio" name="_city_radio" value="{{ $m_city }}"
                             ...
                             data-name="{{ $m_city }}"
                             {{ old('city', $restaurant->city) == $m_city ? 'checked' : '' }}
            ...
            <div class="col-md-4 mb-3">
              ...
              <textarea class="form-control" id="address" name="address" rows="1" placeholder="e.g. 286 Grand Avenue">{{ old('address', $restaurant->address) }}</textarea>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 mb-3">
        ...
        <div class="tab-pane fade" id="featured-pane" role="tabpanel" aria-labelledby="featured-tab">
          ...
          <div class="mb-3">
            ...
            @if($restaurant->featured_image_alt)
              <div class="form-text text-muted mt-1">Current Alt Text: <strong>{{ $restaurant->featured_image_alt }}</strong></div>
            @endif
          </div>
          @endif
        ...
        <div class="tab-pane fade" id="seo-pane" role="tabpanel" aria-labelledby="seo-tab">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="meta_title" name="meta_title" placeholder="e.g. Best Restaurant in Michigan | Michigan Explorer" value="{{ old('meta_title', $restaurant->seo->meta_title ?? '') }}" />
          </div>
          <div class="mb-3">
            ...
            <textarea class="form-control" id="meta_description" name="meta_description" placeholder="e.g. Discover the best restaurant in Michigan..." maxlength="160" rows="2">{{ old('meta_description', $restaurant->seo->meta_description ?? '') }}</textarea>
          </div>
          <div class="mb-3">
              <label class="form-label" for="og_title">OG Title</label>
              <input type="text" class="form-control" id="og_title" name="og_title" placeholder="e.g. Best Restaurant in Michigan" value="{{ old('og_title', $restaurant->seo->og_title ?? '') }}" />
            </div>
          <div class="mb-3">
            ...
            <textarea class="form-control" id="og_description" name="og_description" placeholder="e.g. Discover the best restaurant in Michigan..." maxlength="160" rows="2">{{ old('og_description', $restaurant->seo->og_description ?? '') }}</textarea>
          </div>
          <div class="mb-3">
