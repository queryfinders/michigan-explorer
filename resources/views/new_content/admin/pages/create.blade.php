      ...
      <div class="tab-content p-0" id="pageFormTabsContent">
        ...
        <div class="tab-pane fade show active" id="content-pane" role="tabpanel" aria-labelledby="content-tab">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control tinymce" id="content" name="content" rows="15"></textarea>
          </div>
          --}}
        </div>
        ...
        <div class="tab-pane fade" id="banner-pane" role="tabpanel" aria-labelledby="banner-tab">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="featured_image_alt" name="featured_image_alt" placeholder="Describe the image for search engines e.g. Scenic view of Michigan coastline" />
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="seo-pane" role="tabpanel" aria-labelledby="seo-tab">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="meta_description" name="meta_description" rows="2" maxlength="160" placeholder="Enter meta description (max 160 characters)"></textarea>
          </div>
          <div class="mb-3">
            <label class="form-label" for="og_title">OG Title</label>
            <input type="text" class="form-control" id="og_title" name="og_title" placeholder="Enter OG title" />
          </div>
          <div class="mb-3">
            ...
            <textarea class="form-control" id="og_description" name="og_description" rows="2" maxlength="160" placeholder="Enter OG description (max 160 characters)"></textarea>
          </div>
          <div class="mb-3">
