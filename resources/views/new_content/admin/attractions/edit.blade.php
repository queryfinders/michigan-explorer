      ...
      <div class="tab-content p-0" id="attractionFormTabsContent">
        ...
        <div class="tab-pane fade show active" id="basic-pane" role="tabpanel" aria-labelledby="basic-tab">
                  ...
                  <div class="cuisine-items-list" id="categoryItemsList">
                    ...
                    <label class="cuisine-item" id="cat-label-{{ $cat->id }}">
                      <input type="radio" name="_cat_radio" value="{{ $cat->id }}"
                             ...
                             data-name="{{ $cat->name }}"
                             data-id="{{ $cat->id }}"
                             {{ old('attraction_category_id', $attraction->attraction_category_id) == $cat->id ? 'checked' : '' }}
          ...
          <!-- <div class="mb-3">
            ...
            <textarea class="form-control" id="short_description" name="short_description" rows="2">{{ $attraction->short_description }}</textarea>
          </div> -->
          <div class="mb-3">
            <label class="form-label" for="description">Description</label>
            <textarea class="form-control tinymce" id="description" name="description" rows="6">{{ $attraction->description }}</textarea>
          </div>

          <div class="mb-3">
            <div class="form-check form-switch mt-2">
              <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" {{ $attraction->is_featured == 1 ? 'checked' : '' }}>
                ...
                <div class="cuisine-dropdown-panel" id="cityDropdownPanel" style="display: none;">
                  ...
                  <div class="cuisine-items-list" id="cityItemsList">
                    @foreach(config('michigan_cities') as $m_city)
                      @foreach($attractionPolicies as $policy)
                </div>
                @endforeach
              </div>
            </div>
        ...
        <div class="tab-pane fade" id="featured-pane" role="tabpanel" aria-labelledby="featured-tab">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="featured_image_alt" name="featured_image_alt" value="{{ $attraction->featured_image_alt }}" />
          ...
          <!-- <div class="mb-3 border-top pt-3">
            ...
            @if($attraction->video && !str_starts_with($attraction->video, 'http'))
              <div class="mt-2">
                ...
                <a href="{{ asset($attraction->video) }}" target="_blank" class="small fw-bold">{{ basename($attraction->video) }}</a>
              </div>
            @endif
          </div> -->
          <div class="mb-3">
            <label class="form-label fw-semibold" for="video_url">Video URL</label>
            <input type="url" class="form-control" id="video_url" name="video_url" value="{{ str_starts_with($attraction->video ?? '', 'http') ? $attraction->video : '' }}" />
        ...
        <div class="tab-pane fade" id="gallery-pane" role="tabpanel" aria-labelledby="gallery-tab">
          ...
          @if($attraction->images->count() > 0 || !empty($attraction->video))
          <div class="mb-4">
        ...
        <div class="tab-pane fade" id="seo-pane" role="tabpanel" aria-labelledby="seo-tab">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="meta_title" name="meta_title" placeholder="e.g. Best Attraction in Michigan | Michigan Explorer" value="{{ $attraction->seo->meta_title ?? '' }}" />
          </div>
          <div class="mb-3">
            ...
            <textarea class="form-control" id="meta_description" name="meta_description" placeholder="e.g. Discover the best attraction in Michigan..." maxlength="160" rows="2">{{ $attraction->seo->meta_description ?? '' }}</textarea>
          </div>
          <div class="mb-3">
              <label class="form-label" for="og_title">OG Title</label>
              <input type="text" class="form-control" id="og_title" name="og_title" placeholder="e.g. Best Attraction in Michigan" value="{{ $attraction->seo->og_title ?? '' }}" />
            </div>
          <div class="mb-3">
            ...
            <textarea class="form-control" id="og_description" name="og_description" placeholder="e.g. Discover the best attraction in Michigan..." maxlength="160" rows="2">{{ $attraction->seo->og_description ?? '' }}</textarea>
          </div>
          <div class="mb-3">
...
<div class="modal fade" id="addAttractionPolicyModal" tabindex="-1" aria-labelledby="addAttractionPolicyModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addAttractionPolicyModalLabel"><i class="fas fa-plus-circle me-2 text-primary"></i>Add New Attraction Policy</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="saveNewAttractionPolicy()">
