...
<div class="container detail-container">
    ...
    <div class="gallery-grid mb-4" onclick="openCustomGallery()">
        <div class="gallery-item main-img">
            <img src="{{ !empty($hotel->featured_image) && $hotel->slug !== 'demo' ? asset($hotel->featured_image) : asset('storage/demo/michigan_resort_exterior_1783683587847.png') }}" alt="{{ $hotel->name ?? 'Hotel' }}">
        </div>
        <!-- Thumbnails -->
        <div class="gallery-item"><img src="{{ asset('storage/demo/michigan_hotel_room_1_1783683598842.png') }}" alt="Room 1"></div>
        <div class="gallery-item"><img src="{{ asset('storage/demo/michigan_hotel_room_2_1783683609409.png') }}" alt="Room 2"></div>
        <div class="gallery-item"><img src="{{ asset('storage/demo/michigan_hotel_lobby_1783683621508.png') }}" alt="Lobby"></div>
        <div class="gallery-item">
            <img src="{{ asset('storage/demo/michigan_hotel_pool_1783683632041.png') }}" alt="Resort Pool">
            <div class="gallery-overlay-count">+24</div>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="content-card">
                ...
                <div class="text-muted lh-18">
                    <p>{{ $hotel->description ?: 'Experience the pinnacle of luxury and comfort at our exquisite property. Located in the heart of the city, we offer world-class amenities, stunning views, and exceptional service to make your stay truly unforgettable.' }}</p>
            ...
            <div class="content-card">
                ...
                <div class="amenities-grid-premium">
                    <div class="amenity-card"><i class="fas fa-wifi"></i><span>Free WiFi</span></div>
                    <div class="amenity-card"><i class="fas fa-swimming-pool"></i><span>Indoor Pool</span></div>
                    <div class="amenity-card"><i class="fas fa-parking"></i><span>Free Parking</span></div>
                    <div class="amenity-card"><i class="fas fa-utensils"></i><span>Restaurant</span></div>
                    <div class="amenity-card"><i class="fas fa-dumbbell"></i><span>Gym & Fitness</span></div>
                    <div class="amenity-card"><i class="fas fa-snowflake"></i><span>Air Conditioning</span></div>
                    <div class="amenity-card"><i class="fas fa-coffee"></i><span>Breakfast</span></div>
                    <div class="amenity-card"><i class="fas fa-paw"></i><span>Pet Friendly</span></div>
                </div>
            </div>
...
<script>
    const galleryImages = [
        "{{ !empty($hotel->featured_image) && $hotel->slug !== 'demo' ? asset($hotel->featured_image) : asset('storage/demo/michigan_resort_exterior_1783683587847.png') }}",
        "{{ asset('storage/demo/michigan_hotel_room_1_1783683598842.png') }}",
        "{{ asset('storage/demo/michigan_hotel_room_2_1783683609409.png') }}",
        "{{ asset('storage/demo/michigan_hotel_lobby_1783683621508.png') }}",
