...
@php
    $pageTitle = isset($currentCategory) ? $currentCategory->name . ' in Michigan' : 'Explore Hotels Across Michigan';
    $metaTitle = isset($currentCategory) ? $currentCategory->name . ' - Michigan Explorer' : 'Hotels - Michigan Explorer';
    $metaDescription = isset($currentCategory) && $currentCategory->description 
        ? Str::limit(strip_tags($currentCategory->description), 160) 
        : 'Find luxury hotels, boutique stays, family resorts, and affordable accommodations throughout Michigan.';
    $canonicalUrl = isset($currentCategory) ? route('web.hotels.category', $currentCategory->slug) : route('web.hotels.index');
@endphp
    ...
    <div class="content">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb justify-content-center text-white opacity-75">
                ...
                <li class="breadcrumb-item"><a href="{{ route('web.hotels.index') }}" class="text-white text-decoration-none">Hotels</a></li>
        ...
        <div class="category-bar-inner d-flex flex-column align-items-start gap-2">
            ...
            <div class="category-filter-wrapper d-flex align-items-center flex-wrap gap-2">
                ...
                @php
                    ...
                    // Limit to 6 categories so Budget Hotels is followed by More...
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
                <h5 class="modal-title fw-bold fs-4" id="categoriesModalLabel">All Hotel Categories</h5>
