...
<div class="card premium-card h-100 border-0 rounded-4 shadow-sm overflow-hidden text-decoration-none">
    <div class="img-wrapper position-relative" style="height: 220px; overflow: hidden;">
        <img src="{{ $blog->featured_image ? asset($blog->featured_image) : asset('images/travel_guide_1783508300840.png') }}" class="card-img-top w-100 h-100 object-fit-cover transition-transform" alt="{{ $blog->title }}">
    </div>
