      ...
      <div class="tab-content p-0" id="blogFormTabsContent">
        ...
        <div class="tab-pane fade" id="seo-pane" role="tabpanel">
          ...
          <div class="mb-3">
            ...
            <div class="form-text">Ideal length: 50ΓÇô60 characters.</div>
          </div>
...
<style>
/* ΓöÇΓöÇ Cuisine-style Dropdown (Category & Author) ΓöÇΓöÇ */
...
/* ΓöÇΓöÇ Blog Tag Dropdown ΓöÇΓöÇ */
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /* ΓöÇΓöÇ Character Counter ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Category Dropdown ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Init all dropdowns from saved values ΓöÇΓöÇ */
  (function() {
    // Category
  ...
  /* ΓöÇΓöÇ Outside click closes all ΓöÇΓöÇ */
